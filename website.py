...
def request_wind_POST(MicroWebSrv2, request):
	...
	global Wind_data
	Wind_data = request.GetPostedJSONObject()
	...
	csv.add_parameter(RS232.get_panel_voltage(), RS232.get_panel_current(
	), RS232.get_battery_voltage(), wind_voltage, wind_current)
